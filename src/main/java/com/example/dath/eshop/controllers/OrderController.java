...
import com.example.dath.eshop.exceptions.OrderLineItemException;
...
import com.example.dath.eshop.models.OrderLineItem;
import com.example.dath.eshop.models.User;
import com.example.dath.eshop.securities.ShopMeUserDetail;
import com.example.dath.eshop.services.OrderService;
...
public class OrderController {
    ...
    public String viewOrderDetail(
            @RequestParam("oder-line-item-id") Integer orderLineItemId,
            Model model,
            RedirectAttributes redirectAttributes)
            throws OrderLineItemException {
        try {
    ...
    public String viewPurchaseHistory(
            @PathVariable("pageNum") Integer pageNum, Model model, @AuthenticationPrincipal ShopMeUserDetail user)
